...
interface AdminPanelTabsProps {
  ...
  onUpdateOrderStatus: (orderId: number, status: string, rejectionReason?: string, customDeliveryPrice?: number | null, trackingNumber?: string, customerEmail?: string) => void;
