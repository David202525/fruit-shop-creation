    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <div className="relative inline-block">
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-[20px] min-h-[20px] px-1.5 py-0.5 text-[11px] rounded-full flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600 text-white font-bold shadow-lg animate-pulse pointer-events-none z-10 leading-none">
